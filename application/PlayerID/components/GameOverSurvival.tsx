...
export default function GameOverSurvival() {
  const { mode2Score, mode2HighScore, startMode2 } = useGameStore();
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.submitButton} onPress={startMode2} activeOpacity={0.9}>
